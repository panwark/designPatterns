...
{
    protected State currentState = new Rest();
    ...
    protected void pressRightPedal(int numOfTimesPressed) {
        ...
        switch (this.currentState.name) {
            case "At Rest":
                ...
                if(move){ // no error
                    this.currentState = new Forward(); // current state becomes state MoveForward
                }
                break;
            case "Move Forward":
                move = this.currentState.pressRightPedal(numOfTimesPressed);
    ...
    protected void pressLeftPedalForTime(int numOfSecondsPressed) {
        switch (this.currentState.name) {
            case "At Rest":
                ...
                if(move) { // no error
                    this.currentState = new Backwards(); // current state becomes state MoveBackward
                }
                break;
            case "Move Backward":
